...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-numbers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6757&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-numbers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-numbers` can be installed with:

```
conda install r-numbers
```

It is possible to list all of the versions of `r-numbers` available on your platform with:
